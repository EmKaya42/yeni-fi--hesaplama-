...
- Firma unvanı yalnız belgenin kendi görselinden okunur. Aynı VKN / TCKN bulunsa bile başka belgeden isim tamamlanmaz. Eksik veya iki okumada uyuşmayan unvan boş kalır, belge incelemede tutulur ve Excel'e aktarılmaz.
- Önceki sürümde başka belgeden tamamlanan unvanlar başlangıçta kaldırılır; ilgili kaynak görseller otomatik yeniden okunur. Dosyalar ve önceki Excel hazırlama geçmişi korunur. Daha önce indirilen Excel dosyaları değişmez; yeniden hazırlanmalıdır.
- Kısmen okunan belgelerde eksik/çelişen alanlar ayrıntıların başında ve ilk sorun liste satırında gösterilir. Kesilmiş unvanlar için tamamı görünen fotoğraf gerekir.
